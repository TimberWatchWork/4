...
class MakeUI(Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.lbl = Label(self, text=" Выберите модель: ", padx=10, pady=5, width=15)
        ...
        self.txt1.grid(column=1, row=1, padx=5)
        ...
        self.txt2.grid(column=1, row=2, padx=5)
        ...
        self.txt3.grid(column=1, row=3, padx=5)
        ...
        self.btn.grid(column=2, row=7, padx=5)

        self.txt = scrolledtext.ScrolledText(self, width=40, height=10, state='disabled')
        self.txt.grid(column=2, row=1, rowspan=6)
